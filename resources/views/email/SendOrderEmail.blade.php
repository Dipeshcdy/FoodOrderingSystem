                ...
                <table class="" style="width: 100%; border: 2px solid #cecece;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border-bottom: 1px solid #cecece; font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important;"> {{$cart->price ?? ''}} </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important;"> {{$cart->price ?? ''}} </td>
                        </tr>
                    </tbody>
                </table>
            </div>
