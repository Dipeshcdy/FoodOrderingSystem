            ...
            <div class="" style="padding-top: 1.5rem; width: 100%;">
                <table class="" style="width: 100%; border: 2px solid #cecece;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important; border-right: 1px solid #cecece;">Ordered Date: {{date('Y m d')}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="" style="width: 100%; border: 2px solid #cecece;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important;"> {{$deliveryInfo['location']}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="" style="width: 100%; border: 2px solid #cecece;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border-bottom: 1px solid #cecece; font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important;"> {{$grandTotal}} </td>
                        </tr>
                        <tr>
